...
var paths = {
  ...
  sass_src: 'assets/styles/src/**/*.{scss,sass,css}',
  sass_dist: 'assets/styles',
  sass_main: 'assets/styles/src/main.scss',
};

var paths_admin = {
  scripts_src: 'assets@admin/scripts/src/**/*.js',
  scripts_dist: 'assets@admin/scripts',
  sass_src: 'assets@admin/styles/src/**/*.{scss,sass,css}',
  sass_dist: 'assets@admin/styles',
  sass_main: 'assets@admin/styles/src/main.scss',
};
...
gulp.task('sass', ['clean'], function () {
  gulp.src(paths.sass_main)
    .pipe(sass({outputStyle: 'compressed', errLogToConsole: true, includePaths: ['assets/styles/src']}))
...
gulp.task('sass_admin', ['clean'], function () {
  gulp.src(paths_admin.sass_main)
    .pipe(sass({style: 'compact', errLogToConsole: true, includePaths: ['assets@admin/styles/src']}))
    .pipe(prefix("last 500 version"))
